...
void Dialog::AQI()                                  //affichage de l'AQI et l'icone correspondante
{
    ...
    if (aqi_value>=0 && aqi_value<=50)
    {
        ...
        //fondPlan.load("/mnt/storage/Pictures/aqi_g.png");
        fondPlan.load("/home/haissam/Images/AQI/aqi_g.png");
    ...
    else if (aqi_value>=51 && aqi_value<=100)
    {
        ...
        //fondPlan.load("/mnt/storage/Pictures/aqi_m.png");
        fondPlan.load("/home/haissam/Images/AQI/aqi_m.png");
        ui->label_IAQI->setPixmap(fondPlan);
    }
    ...
    else if (aqi_value>=101 && aqi_value<=150)
    {
        ...
        //fondPlan.load("/mnt/storage/Pictures/aqi_u1.png");
        fondPlan.load("/home/haissam/Images/AQI/aqi_u1.png");
        ui->label_IAQI->setPixmap(fondPlan);
    }
    ...
    else if (aqi_value>=151 && aqi_value<=200)
    {
        ...
        //fondPlan.load("/mnt/storage/Pictures/aqi_u2.png");
        fondPlan.load("/home/haissam/Images/AQI/aqi_u2.png");
        ui->label_IAQI->setPixmap(fondPlan);
    }
    ...
    else if (aqi_value>=201 && aqi_value<=300)
    {
        ...
        //fondPlan.load("/mnt/storage/Pictures/aqi_vu.png");
        fondPlan.load("/home/haissam/Images/AQI/aqi_vu.png");
        ui->label_IAQI->setPixmap(fondPlan);
    }
    ...
    else
    {
        ...
        //fondPlan.load("/mnt/storage/Pictures/aqi_h.png");
        fondPlan.load("/home/haissam/Images/AQI/aqi_h.png");
        ui->label_IAQI->setPixmap(fondPlan);
...
void Dialog::Icon()                                        //affichage de l'icone meteo
{
    ...
    //ic.load(QString("//mnt/storage/Pictures/%1.png").arg(icon));
    ic.load(QString("/home/haissam/Images/ICON/%1.png").arg(icon));
...
void Dialog::printHashprevision()
{
    ...
    /*Création du graphique de l'onglet prévision*/
     ...
     QLineSeries *series = new QLineSeries();
        ...
        /*on cherche la température maximale pour pouvoir définier le max de l'axe y*/
        ...
        axisY->setLabelFormat("%.1f");                                //un chiffre après la virgule
        chart->addAxis(axisY, Qt::AlignLeft);
        series->attachAxis(axisY);
...
void Dialog::printHashindice()                                 //Affichage de l'indice UV et de l'icon correspondante
{
    ...
    if (indice_value>=0 && indice_value<=2)
    {
        ...
        //soleil.load("/mnt/storage/Pictures/s1.png");
        soleil.load("/home/haissam/Images/UV/s1.png");
    ...
    else if (indice_value>=3 && indice_value<=5)
    {
        ...
        //soleil.load("/mnt/storage/Pictures/s2.png");
        soleil.load("/home/haissam/Images/UV/s2.png");
        ui->label_IUV->setPixmap(soleil);
    }
    ...
    else if (indice_value>=6 && indice_value<=7)
    {
        ...
        //soleil.load("/mnt/storage/Pictures/s3.png");
        soleil.load("/home/haissam/Images/UV/s3.png");
        ui->label_IUV->setPixmap(soleil);
    }
    ...
    else if (indice_value>=8 && indice_value<=10)
    {
        ...
        //soleil.load("/mnt/storage/Pictures/s4.png");
        soleil.load("/home/haissam/Images/UV/s4.png");
        ui->label_IUV->setPixmap(soleil);
    }
