...
void MainWindow::initButtons()
{
    ...
    connect(ptr, SIGNAL(callFinished(QList<Abstract_API::GeoObj>, API_index)), this, SLOT(dataReceived(QList<Abstract_API::GeoObj>)));
    connect(buttonEv, SIGNAL(RazSig(int)), this, SLOT(RazSlot(int)));
    ...
    connect(ptr, SIGNAL(callFinished(QList<Abstract_API::GeoObj>, API_index)), this, SLOT(dataReceived(QList<Abstract_API::GeoObj>)));
    connect(pharmButton, SIGNAL(RazSig(int)), this, SLOT(RazSlot(int)));
    ...
    connect(ptr, SIGNAL(callFinished(QList<Abstract_API::GeoObj>, API_index)), this, SLOT(dataReceived(QList<Abstract_API::GeoObj>)));
    connect(bornesElecBtn, SIGNAL(RazSig(int)), this, SLOT(RazSlot(int)));
    ...
    connect(ptr, SIGNAL(callFinished(QList<Abstract_API::GeoObj>, API_index)), this, SLOT(dataReceived(QList<Abstract_API::GeoObj>)));
    connect(QueFaire_btn, SIGNAL(RazSig(int)), this, SLOT(RazSlot(int)));
    ...
    connect(ptr, SIGNAL(callFinished(QList<Abstract_API::GeoObj>, API_index)), this, SLOT(dataReceived(QList<Abstract_API::GeoObj>)));
    connect(Kiosques_btn, SIGNAL(RazSig(int)), this, SLOT(RazSlot(int)));
    ...
    connect(ptr, SIGNAL(callFinished(QList<Abstract_API::GeoObj>, API_index)), this, SLOT(dataReceived(QList<Abstract_API::GeoObj>)));
    connect(fontaines_btn, SIGNAL(RazSig(int)), this, SLOT(RazSlot(int)));
    ...
    connect(ptr, SIGNAL(callFinished(QList<Abstract_API::GeoObj>, API_index)), this, SLOT(dataReceived(QList<Abstract_API::GeoObj>)));
    connect(terrassesBtn, SIGNAL(RazSig(int)), this, SLOT(RazSlot(int)));
    ...
    connect(ptr, SIGNAL(callFinished(QList<Abstract_API::GeoObj>, API_index)), this, SLOT(dataReceived(QList<Abstract_API::GeoObj>)));
    connect(buttonToilette, SIGNAL(RazSig(int)), this, SLOT(RazSlot(int)));
    ...
    connect(ptr, SIGNAL(callFinished(QList<Abstract_API::GeoObj>, API_index)), this, SLOT(dataReceived(QList<Abstract_API::GeoObj>)));
    connect(buttonRatpGlobal, SIGNAL(RazSig(int)), this, SLOT(RazSlot(int)));
...
//    connect(buttonRatpSearch, SIGNAL(clicked()), this, SLOT(ratpDialog()));
    ...
    connect(ptr, SIGNAL(callFinished(QList<Abstract_API::GeoObj>, API_index)), this, SLOT(dataReceived(QList<Abstract_API::GeoObj>)));
    connect(buttonEspacesVerts, SIGNAL(RazSig(int)), this, SLOT(RazSlot(int)));
    ...
    connect(ptr, SIGNAL(callFinished(QList<Abstract_API::GeoObj>, API_index)), this, SLOT(dataReceived(QList<Abstract_API::GeoObj>)));
    connect(buttonWiFi, SIGNAL(RazSig(int)), this, SLOT(RazSlot(int)));
    ...
    connect(ptr, SIGNAL(callFinished(QList<Abstract_API::GeoObj>, API_index)), this, SLOT(dataReceived(QList<Abstract_API::GeoObj>)));
    connect(buttonTheatre, SIGNAL(RazSig(int)), this, SLOT(RazSlot(int)));
    ...
    connect(ptr, SIGNAL(callFinished(QList<Abstract_API::GeoObj>, API_index)), this, SLOT(dataReceived(QList<Abstract_API::GeoObj>)));
    connect(buttonVelib, SIGNAL(RazSig(int)), this, SLOT(RazSlot(int)));
}
...
void MainWindow::RazSlot(int)
{
    QList<Abstract_API::GeoObj> emptyList;
    dataReceived(emptyList);
}
