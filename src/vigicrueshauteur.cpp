...
void VigiCruesHauteur::setRequest()
{
    ...
    QUrl url("http://hubeau.eaufrance.fr/api/v1/hydrometrie/observations_tr?bbox=2.363348007202149%2C48.84285889094348%2C2.368412017822266%2C48.84669988998153&code_entite=F700000103&date_debut_obs=2019-05-07&distance=10&grandeur_hydro=H&latitude=48.861469422154464&longitude=2.34630372400731&size=200&sort=asc");
    request.setUrl(url);
